...
/* REV runtime-configurable module param for beacon rate */
int rev_beacon_rate = IEEE80211_OFDM_RATE_6MB; /* See IEEE80211_OFDM_RATE_ values in ieee80211.h */
module_param(rev_beacon_rate, int, 0664);
...
void issue_beacon(_adapter *padapter, int timeout_ms)
{
	...
	/* Added by REV: Set configured rate for this beacon */
    pattrib->rate = (u8)rev_beacon_rate;
